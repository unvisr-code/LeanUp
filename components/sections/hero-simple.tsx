...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-gradient-to-br from-blue-600 via-blue-500 to-blue-700 flex items-center">
      {/* Subtle gradient overlay */}
      <div className="absolute inset-0">
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-blue-600/20 to-blue-800/30" />
      </div>
          ...
          >
            {[
              ...
              <motion.div
                ...
                className="group relative bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20 transition-all hover:bg-white/15 hover:border-white/30 hover:shadow-xl hover:shadow-blue-500/10"
              >
